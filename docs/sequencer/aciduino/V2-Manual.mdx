---
title: V2 Manual
description: Aciduino V2 Manual
---
...
![MIDI Sequencer Interface](//img/aciduino/BasicControls.png)
...
808: [Pot] Changes voice [Shift + Pot] Changes voice config(midi cc or cv port)  
 ...
 ### System Page syst
![MIDI Sequencer Interface](/img/aciduino/SystPage1.png)
![MIDI Sequencer Interface](/img/aciduino/SystPage2.png)
 ...
 ### Sequencer page seqr
 ![MIDI Sequencer Interface](/img/aciduino/Seqr303Page1.png)
 ![MIDI Sequencer Interface](/img/aciduino/Seqr303Page2.png)
 ...
 ### Generator page gene
 ![MIDI Sequencer Interface](/img/aciduino/Gene303Page1.png)
 ![MIDI Sequencer Interface](/img/aciduino/Gene303Page2.png)
 

 - **Header bar:** 

 ### Pattern page ptrn
 ![MIDI Sequencer Interface](/img/aciduino/PtrnPage1.png)
  ![MIDI Sequencer Interface](/img/aciduino/PtrnPage2.png)

 - **Header bar:** Contains
 ### MIDI page midi
 ![MIDI Sequencer Interface](/img/aciduino/MidiPage1.png)
...
## Cheatsheet
![MIDI Sequencer Interface](/img/aciduino/cheatsheet.png)
