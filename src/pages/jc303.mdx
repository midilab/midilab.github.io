  ...
  - background: ''
    ...
    actions:
      - title: Download for Windows
        href: >-
          https://github.com/midilab/jc303/releases/download/v0.12.0/jc303-0.12.0-windows_x64-plugins.zip
        _template: link
      - title: Download for Mac
        href: >-
          https://github.com/midilab/jc303/releases/download/v0.12.0/jc303-0.12.0-macos-universal-plugins.zip
        _template: link
      - title: Download for Linux
        href: >-
          https://github.com/midilab/jc303/releases/download/v0.12.0/jc303-0.12.0-linux_x64-plugins.zip
        _template: link
    _template: hero
---
...
4.  **Rescan:** After copying the files (and de-quarantining on macOS), open your Digital Audio Workstation (DAW) and perform a plugin rescan if it doesn't automatically detect the new JC-303 plugin.
