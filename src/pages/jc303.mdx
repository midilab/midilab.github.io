...
blocks:
  - background: ''
    title: JC-303
    subtitle: >-
      Unlock the iconic sound of Roland's TB-303 Bass Line with JC-303, a faithful emulation of the legendary acid house and techno synthesizer based on Open303.
      JC-303 is open-source and comes free of charge (!) as a VST2, VST3, LV2, CLAP, and AU compatible plugin for your Linux, macOS or Windows based DAW.
    actions:
...
<CardSection
  cards={[
    ...
    },
    {
      ...
      _template: "Card",
      content: "JC-303 is available for all three major desktop music production platforms; Windows, macOS, and Linux."
    },
    {
      type: "title",
