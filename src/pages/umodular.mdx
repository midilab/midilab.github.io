  ...
  cards={[
    {
      ...
      content:
        "Roland-inspired step sequencer (up to 16 tracks) with deep control grid. Uses µMODULAR hardware/firmware for MIDI I/O, controls & display."
    },
    {
      _template: "Card",
      ...
      content:
        "Midilab's custom live/production unit: 16-track step sequencer, advanced MIDI controller, real-time programming, and named controls via display."
    },
    {
      _template: "Card",
      title: "XR-1 Groovebox (by James Gray)",
      youtubeVid: "s68AS_JNLJU",
      content:
        "A complete groovebox demonstrating the power of the uClock timing library (part of the µMODULAR firmware ecosystem) for tight sequencing."
    },
    {
      _template: "Card",
      title: "MIDI Looper (by ymnkmusic)",
      youtubeVid: "7VqLjlL3LzU",
      content:
        "Real-time MIDI looping and sequencing capabilities, built upon the reliable timing provided by the uClock firmware library.",
      to: ""
    },
    {
      _template: "Card",
      title: "MIDI/DIN Sync Box (by ymnkmusic)",
      youtubeVid: "OYtPbgozCbE",
      content:
        "A practical utility box for synchronizing MIDI and DIN Sync gear, showcasing the flexibility of the uClock library for timing tasks.",
      to: ""
    }
  ]}
/>
