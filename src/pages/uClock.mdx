...
<Hero data={{title: "µClock Library", subtitle: "Precision BPM Clock Generation for Arduino/PlatformIO using Hardware Timers.", actions: [{title: "View Releases on GitHub", href: "https://github.com/midilab/uClock/releases", _template: "link"}, {title: "Browse µClock Repository", href: "https://github.com/midilab/uClock", _template: "link"}]}} />
